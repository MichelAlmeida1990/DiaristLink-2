...
export default function DiaristJobsHistoryPage() {
  ...
  const loadJobs = async () => {
    try {
      ...
      // Buscar apenas jobs completados da diarista
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-gray-600">
                Ganhos totais: R$ {jobs.reduce((sum, j) => sum + parseFloat(j.price.toString()), 0).toFixed(2)}
              </p>
            </CardContent>
          </Card>
        </div>
              ...
              <Card key={job.id} className="border-green-200">
                ...
                <CardContent>
                  <div className="grid md:grid-cols-3 gap-4 text-sm mb-4">
                    ...
                    <div>
                      <p className="text-gray-500">Ganho</p>
                  ...
                  {job.employer && (
                    <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-md">
                      ...
                      <div>
                        <p className="text-sm font-medium">Empregador: {job.employer.name || 'Não informado'}</p>
